...
CREATE TABLE `donations` (
  ...
  `tribute_email` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `donor_name` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `item_list` VALUES (1000,'life','life',1,45,70,100,150),(2000,'immunity','immunity',1,300,300,300,300),(3000,'golden_resource','golden resource',1,300,300,300,300),(3001,'food_resource','food resource',1,80,100,100,100),(3002,'water_resource','water resource',1,100,100,120,120),(3003,'medicine_resource','medicine resource',1,75,100,125,125),(3004,'Baseball Bat (Thin)','A thin baseball bat',3,60,70,80,80),(3005,'Baseball Bat (Fat)','comes with 3 balls',3,35,50,60,60),(3006,'Police Baton','Shorter than a bat, but fairly sturdy',5,45,60,70,70),(3007,'Whirly Tube','You already know',3,45,60,70,70),(3008,'Cutlass','A short sword',3,35,50,60,60),(3009,'Nerf Gun (triple shot)','A deadly long range weapon',3,200,250,300,300),(3010,'Nerf Revolver','A long range weapon that holds up to 6 shots',1,150,175,200,200),(3011,'Zing Bow','Comes with 3 arrows',3,200,250,300,300),(3012,'Nerf Ammo (x5)','Ammo for nerf guns',20,20,25,30,40),(3013,'Soaker Ball','A squishy projectile',20,10,10,15,20),(3014,'Hacky Sack','A semi-firm projectile',1,15,15,20,20),(3015,'Soft Projectiles (Small)','Any of the soft projectiles',20,15,15,20,25),(3016,'Hollow Golf Balls','Lightweight projectile',10,15,15,20,25),(3017,'Hollow Baseballs','Large lightweight projectile',5,15,15,20,25),(3018,'Suction Cup Ball','Solid and lightweight',3,15,15,20,25),(3019,'Large Soft Football','A large projectile',3,50,75,80,100),(3020,'Rubber Football','A soft, rubber projectile',3,15,15,20,25),(3021,'Shield','A necessity for close range combat',10,200,200,200,200);
...
CREATE TABLE `life_events` (
  ...
  `notes` varchar(75) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `purchases` (
  ...
  `payer_email` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `receiver_email` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `category` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `item_name` varchar(25) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `resource_list` (
  ...
  `used_by` varchar(300) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `tributes` (
  ...
  `districtPartner_email` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `area` varchar(15) COLLATE utf8mb4_general_ci NOT NULL,
  `mentor_email` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `email` varchar(70) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `permissions` varchar(10) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
...
-- Dump completed on 2020-02-01 17:42:53
